...
namespace ApiVersionControl.Controllers.V1
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        [MapToApiVersion("1.0")] // estara disponible unicamente para esta version
        ...
        public async Task<IActionResult> GetUsersDataAsync()
        {
            ...
            //var userData = JsonSerializer.Deserialize<UserResponseData>(response, new JsonSerializerOptions
            //{
